...
assert (BOARDWIDTH * BOARDHEIGHT) % 2 == 0, 'Board needs to have an even number of boxes for pairs of matches.gggggg'
...
def main():
    ...
    while True: # main game loop
            ...
            if not revealedBoxes[boxx][boxy] and mouseClicked:
                ...
                if firstSelection == None: # the current box was the first box clicked
                    ...
                    if icon1shape != icon2shape or icon1color != icon2color:
                        ...
                        beep=pygame.mixer.Sound('alarm_beep.wav')
                        beep.play()
        ...
        title = pygame.font.Font('dacasa.ttf',70)
        TextSurf, TextRect = text_objectsB("Test your Memory!", title)
